...
-- A large number of employees were between 26-40 followed by 41-55 while 
-- the smallest group was 55+.
...
-- The gender distribution across departments is fairly balanced 
-- but there are generally more male than female employees.

-- The Auditing department has the highest turnover rate followed
-- by Legal. The least turn over rate are in the Marketing,
-- Business Development and Sales.

-- A large number of employees come from the state of Ohio, followed by
-- Pennsylvania and Illinois.

-- The net change in employees has increased over the years.

-- The average tenure for each department is about 8 years with Legal
-- and Auditing having the highest and Services, Sales and Marketing
-- having the lowest.

-- Limitations

-- Some termdates were far into the future and were
-- not included in the analysis(1414 records).
